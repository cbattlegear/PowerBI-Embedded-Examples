...
$(function () {
    ...
    $.ajax({
        type: "GET",
        url: "/embedinfo/getembedCreateinfo",
        success: function (data) {
            ...
            reportLoadConfig = {
                ...
                embedUrl: embedParams.EmbedCreate[0].EmbedUrl,
                datasetId: embedParams.EmbedCreate[0].DatasetId
            ...
            report = powerbi.createReport(reportContainer, reportLoadConfig);
